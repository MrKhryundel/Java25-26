...
public class Lab4 {
    public static void main(String[] args) {
        ...
        // Створення кліток для різних видів тварин
        ...
        // Створення зоопарку та додавання кліток
        Zoo zoo = new Zoo();
...
class Cage<T extends Animal> {
    ...
    // Метод для отримання класу допустимого типу тварини
    protected Class<T> getAnimalClass() {
        // Цей метод буде перевизначений у підкласах
        return null;
    }

    // Додавання тварини з перевіркою типу та заповненості
    public void addAnimal(T animal) {
        if (getAnimalClass() != null && !getAnimalClass().isInstance(animal)) {
            throw new ClassCastException("Cannot add " + animal.getClass().getSimpleName() +
                    " to this cage of " + getAnimalClass().getSimpleName());
        }
    ...
    // Видалення тварини з перевіркою наявності
    ...
    // Повертає копію списку тварин, щоб не можна було змінювати оригінал
...
class LionCage extends Cage<Lion> {
    ...
    @Override
    protected Class<Lion> getAnimalClass() {
        return Lion.class;
    }
}
...
class BirdCage extends Cage<Bird> {
    ...
    @Override
    protected Class<Bird> getAnimalClass() {
        return Bird.class;
    }
}
...
class HoofedCage extends Cage<Hoofed> {
    ...
    @Override
    protected Class<Hoofed> getAnimalClass() {
        return Hoofed.class;
    }
}
...
class Zoo {
    // Список кліток, можна використовувати wildcard для generics
    public final List<Cage<? extends Animal>> cages = new ArrayList<>();

    // Підрахунок всіх тварин у зоопарку
